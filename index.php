...
<body>
    ...
    <main>
        <div id="dessusBareFlotaison">
            <img src="./img/circle.png" alt="circleOne" class="circleOne">
            <div class="title">
                <h2>Who am I</h2>
                <div class="inter">?</div>
            </div>
            <img src="./img/circle.png" alt="circleTwo" class="circleTwo">
            <div class="arrow"></div>
        </div>
        <div class="dessous row-9 d-flex flex-column align-items-center">
            ...
            <div class="projects row d-flex flex-wrap flex-column justify-content-center">
